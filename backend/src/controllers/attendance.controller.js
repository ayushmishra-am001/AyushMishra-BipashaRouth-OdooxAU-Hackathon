...
async function checkIn(req, res) {
  ...
  // A row can already exist for today with no check_in - e.g. an approved-leave
  // placeholder (see markLeaveDates in leave.controller.js's approve flow).
  // Only a real check_in means the person is actually already checked in.
